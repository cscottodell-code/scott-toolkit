...
function runStatusline() {
  ...
  try {
    ...
    // GSD was abandoned 2026-04-28. Two blocks were removed here on
    // 2026-07-24: the .planning/STATE.md lookup (that directory no longer
    // exists anywhere, so it walked up 10 levels stat-ing on every render
    // and always returned empty) and the "/gsd-update" nag (its cache went
    // stale 2026-06-09 and nothing regenerates it, so it displayed forever).
    // The helper functions below are left in place because
    // gsd-check-update-worker.js still imports them.
    // Backup: gsd-statusline.js.pre-nag-patch-2026-07-24.bak
